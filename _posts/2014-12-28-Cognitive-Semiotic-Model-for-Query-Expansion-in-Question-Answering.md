...
1. Строим контекстно-свободную грамматику $$G$$ из ассоциативной сети и словаря синонимов \cite{Abramov99};
...
## 3.2. Контекстно-зависимая грамматика.
...
## 3.3. Классификатор релевантности термов.
