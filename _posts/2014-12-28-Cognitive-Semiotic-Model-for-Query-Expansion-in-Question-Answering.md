...
Запуск модели с запросом "Столица крупнейшей нефтедобывающей страны" производит набор символов, который содержит верный ответ "Москва" в позиции 2 и менее релевантные символы "город", "Россия" в позициях (7, 1) (см. таблицу 2).
